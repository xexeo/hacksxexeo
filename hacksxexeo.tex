...
\usepackage{xcolor}
\usepackage[sugestoes,biblatex,comentarios,rascunhos,anonimizar,assuntos]{hacksxexeo} 
\usepackage{datetime}
\usepackage{hyperref}
...
uma \profsug{uma sem comentário}, usando o comando \verb*|\profsug|, que só tem uma inserção de texto. Também é possível \profrem[Aqui remove]{remover} ou \proftroca[trocando a palavra]{cambiar}{trocar.}
