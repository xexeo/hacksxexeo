...
\usepackage{xcolor}
\usepackage[biblatex,rascunho,comentarios,anonimizar,assuntos]{hacksxexeo} 
\usepackage{datetime}
\usepackage{hyperref}
...
%Este parágrafo \profsug[Uma sugestão]{tem uma sugestão com comentário} e uma \profsug{uma sem comentário}, usando o comando \verb*|!\profsug|, que só tem uma inserção de texto.
